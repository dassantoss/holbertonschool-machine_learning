...
class NST:
    ...
    def __init__(self, style_image, content_image, alpha=1e4, beta=1, var=10):
        ...
        - var (float): The weight for variational cost. Default is 10.
        ...
        - TypeError: If var is not a non-negative number, raises an error
    ...
    def compute_grads(self, generated_image):
        ...
        - `gradients`: tf.Tensor containing gradients for the generated image
