#!/usr/bin/env python3
"""Module to calculate the posterior probability of developing severe
side effects."""
import numpy as np
...
def marginal(x, n, P, Pr):
    ...
    # Calculate the intersection of the data
    inter = intersection(x, n, P, Pr)

    # The marginal probability is the sum of the intersections
    marginal_prob = np.sum(inter)
